    ...
    columns: [
      {
        shortDesc: "Makes me...",
        name: 'Mad',
        description: 'Things that the team found frustrating in the last iteration.'
      },
      {
        shortDesc: "Makes me...",
        name: "Sad",
        description: "Things that the team found disappointing in the last iteration."
      },
      {
        shortDesc: "Makes me...",
        name: "Glad",
        description: "‍Things that made the team happy and excited in the last iteration."
      }
    ]
  }
]
      ...
      <div>
        ...
        <div className="main">
          ...
          <div className="main__wrapper">
            <Switch>
              <Route path="/" exact>
                <Landing actionItems={actionItems} setActionItems={setActionItems} />
              </Route>
              <Route path="/create" >
                <CreateRetro retros={retros} setSelectedRetro={setSelectedRetro} selectedRetro={selectedRetro} />
              </Route>
              <Route path="/retro" >
                <Retro retro={retros[selectedRetro]} actionItems={actionItems} setActionItems={setActionItems} />
              </Route>
            </Switch>
          </div>
        </div>
